...
(function() {
  ...
  CropTool = (function() {
    ...
    CropTool.prototype.init = function() {
      ...
      return $(_image).load((function(_this) {
        return function() {
  ...
  Dropzone = (function() {
    ...
    Dropzone.prototype.dragHandler = function(event) {
      ...
      return this.dragId = delay(100, (function(_this) {
        return function() {
          _this.dragId = null;
          _this.hide();
          _this.dragStop();
  ...
  window.ImageEditor = (function(_super) {
    ...
    ImageEditor.prototype.toggleAspectRatio = function() {
      var h, ratio, ratioInactive, w, _ref;
